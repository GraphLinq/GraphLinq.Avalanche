...
{
    [NodeDefinition("GetAvaxTransactionParametersNode", "Get Transaction Parameters", NodeTypeEnum.Function, "Blockchain.Avalanche")]
    [NodeGraphDescription("Parse the last Avalanche transaction object received into string out parameters readable")]
    public class GetAvaxTransactionParametersNode : Node
    {
        public GetAvaxTransactionParametersNode(string id, BlockGraph graph)
            : base(id, graph, typeof(GetAvaxTransactionParametersNode).Name)
        {
